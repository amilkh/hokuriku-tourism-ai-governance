...
本リポジトリは **Distributed Human Data Engine (DHDE)** を実装します。AIカメラ人流データ、気象庁（JMA）観測値、Googleビジネスプロフィールの検索意図、および97,719件の北陸観光アンケート回答を統合した、観光分析・政策提言パイプラインです。
...
| **最大予測因子** | Google `directions` | 経路検索意図、β = +0.456 |
