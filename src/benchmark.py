...
def classify_feature_families(
    ...
    """Map feature columns into weather / rsi_intent / calendar families."""
    weather_names = {
    ...
    return {
        ...
        "rsi_intent": [c for c in feature_cols if c in intent],
...
def run_benchmark(data: dict[str, Any], reporter: Reporter) -> BenchmarkResult:
    ...
    Args:
        data: Must include:
            ...
            - ``route_col``: RSI intent column name (for family tagging).
